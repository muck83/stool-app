...
export const chinaIbParent = {
  ...
  meta: {
    ...
    zh: {
      ...
      doubleReductionNote: '双减政策（2021年7月由国务院颁布）为选择IB学校的家庭提供了重要背景。该政策削减了国家课程的课外学科补习时间，限制了作业负担——这是政府对应试压力带来的收益递减和挤占全面发展空间这一研究结论的回应。中国的IB学校在独立的监管空间内运营，不受双减直接约束；部分家庭转向IB学校，一定程度上也因为该政策削减了以往依赖的补习体系。高考路径不受影响——大多数国内高校对中国公民仍要求高考成绩，双减并未改变这一现实。但双减的政策意图——培养具有综合能力和全面发展的学生，而非应试专家型毕业生——恰恰正是IB课程所致力于实现的目标。选择IB不是选择背离中国教育价值观，而是选择一条通向中国决策者自身所认定目标的结构化路径。',
