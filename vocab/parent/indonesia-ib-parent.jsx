export const indonesiaIbParent = {
  ...
  meta: {
    en: {
      ...
      reassurance: 'Your choice of IB is not a gamble. But it is a different path. Understanding that path—its strengths, its tradeoffs, and how to navigate it—is what this guide provides. One research context worth holding: Indonesia\'s Merdeka Belajar ("Freedom to Learn") curriculum reform, launched by the Ministry of Education in 2020 and rolled out through 2024, explicitly moves the national system toward competency-based learning, student projects (P5), differentiated instruction, and reduced emphasis on standardised testing — exactly the pedagogy IB schools have been running for decades. The policy direction of the Indonesian government and the pedagogy of the IB are no longer in tension; they are converging. Choosing IB is not choosing against Indonesian education values. It is choosing a mature, well-evidenced version of the approach Indonesian policymakers have themselves identified as the goal.',
      ...
      researchAnchor: 'A piece of learning-science evidence that reframes the bimbel question: the Education Endowment Foundation (EEF) Teaching and Learning Toolkit — a UK government-funded meta-review — consistently identifies metacognition (thinking about thinking) and self-regulation as among the highest-leverage interventions in all of schooling, associated with roughly 7 months of additional progress per year. Bimbel drill, by design, does the opposite — it builds rapid pattern-matching on specific question types but actively discourages the reflective pause that metacognition research identifies as the most durable driver of learning. The IB programme is built, at its core, on exactly the metacognitive habits the EEF research highlights. This is not coincidence; it is shared evidence base.',
    },
    id: {
