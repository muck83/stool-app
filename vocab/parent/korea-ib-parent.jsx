...
export const koreaIbParent = {
  ...
  meta: {
    en: {
      ...
      koreanUniversityNote: 'For families considering returning to Korea: Korean universities — including SKY (Seoul National, Yonsei, Korea University) and most major institutions — recognise the IB Diploma for international admissions. Two important nuances for 2026: Seoul National University lists the IB Diploma as supplementary material in its evaluation process, not a standalone primary credential. Korea University\'s overseas Korean (재외국민) pathway requires that the student completed their entire education — all 16 years from primary school through graduation — outside Korea. Both policies are more conditional than a simple \'IB recognised\' statement implies. If Korean university entry is a possibility, your school\'s counsellor should be consulted in Year 9 or 10, not Year 12.',
      reassurance: 'One thing that does not change: your child is still learning Mathematics, Science, and Languages. They are still being rigorously assessed. They are still being prepared for university. The differences are in how progress is tracked and how learning is structured — not in whether rigour exists. A piece of evidence worth sitting with as you navigate the hagwon (학원) reflex: Yeager et al.\'s 2022 Nature paper on *synergistic mindsets* — a large multi-site study with adolescents — found that the students who performed best under academic pressure were not those who studied more hours. They were those whose parents and teachers helped them frame the physical sensations of stress (racing heart, tight chest, spinning thoughts) as the body getting ready to perform, not as a sign of being overwhelmed. Combined with a growth mindset, this "stress-is-enhancing" reframe produced substantial performance *and* wellbeing gains. Korean adolescents already face some of the highest academic pressure in the OECD (the Korean suicide rate for 15–24-year-olds is the highest among developed nations); the evidence says the protective response is not to pile on more hagwon but to help young people interpret their own stress productively. That kind of support is exactly what the IB pastoral environment is built for — and exactly what hagwon culture, by design, does not provide.',
    },
    ko: {
