...
export const chinaIbParent = {
  ...
  meta: {
    en: {
      ...
      reassurance: 'One thing that does not change: your child is still learning Mathematics, Science, and Languages to a high standard. The content depth in IB Mathematics and Sciences is rigorous — in many cases, IB HL Mathematics goes beyond what the Chinese national curriculum covers at that level. The differences are in how learning is structured, how assessment works, and how progress is reported — not in whether rigour exists. On Chinese language: IB schools offer Chinese Language and Literature (Chinese A) for native Chinese speakers. This is a full rigorous literature and language course — classical texts, essay writing, oral commentary — not a heritage language class. Your child\'s Chinese does not stop at the school gate. A research anchor that reframes a common anxiety: Kim et al. (2013, Asian American Journal of Psychology), tracking 444 Chinese American families over eight years, found that "supportive" parenting (high warmth, high structure, clear standards) produced better GPA, stronger educational attainment, closer family bonds, and lower adolescent depression than "tiger" parenting (high control, low warmth). The study is important precisely because it is within-culture — it separates the stereotype from the evidence. Stevenson & Stigler\'s TIMSS Video Study, now the foundation for the OECD\'s interest in Asian mathematics pedagogy, similarly documents that the strongest feature of Chinese and Japanese maths teaching is not drill volume — it is the structured use of a single rich problem to develop conceptual understanding. IB inquiry-based maths is closer to the best of what Chinese pedagogy already does than it is to anything alien.',
      ...
      doubleReductionNote: 'The 双减 (shuāngjian, "double reduction") policy, enacted by China\'s State Council in July 2021, is relevant context for families choosing IB schools. The policy cut after-school academic tutoring hours and capped homework loads in the national curriculum — a government response to evidence that exam-driven pressure was producing diminishing returns and crowding out broader development. IB schools in China operate in a separate regulatory space and were not directly constrained by 双减; some families moved toward IB schools partly because the policy reduced the tutoring infrastructure that had supplemented the national curriculum. 双减\'s policy intent — developing intellectually capable, well-rounded students rather than exam-specialist graduates — is precisely what the IB programme is designed to produce. Choosing IB is not choosing against Chinese education values; it is choosing a structured path toward the outcomes that Chinese policymakers themselves have identified as the goal. Research published in 2024 documents the policy\'s tangible effects: subject-based tutoring institutions fell from approximately 124,000 to fewer than 9,000 within two years of implementation, and measurable declines in student depression and anxiety followed. The same research found that underground tutoring persists as families seek competitive advantage through informal networks, and that teacher workload increased significantly — over 90% of teachers reported longer working hours. (Chen & Lin, 2024, ECNU Review of Education.)',
    ...
    zh: {
      ...
      doubleReductionNote: '双减政策（2021年7月由国务院颁布）为选择IB学校的家庭提供了重要背景。该政策削减了国家课程的课外学科补习时间，限制了作业负担——这是政府对应试压力带来的收益递减和挤占全面发展空间这一研究结论的回应。中国的IB学校在独立的监管空间内运营，不受双减直接约束；部分家庭转向IB学校，一定程度上也因为该政策削减了以往依赖的补习体系。双减的政策意图——培养具有综合能力和全面发展的学生，而非应试专家型毕业生——恰恰正是IB课程所致力于实现的目标。选择IB不是选择背离中国教育价值观，而是选择一条通向中国决策者自身所认定目标的结构化路径。',
  ...
  cards: [
    {
      ...
      en: {
        ...
        bridge: 'IB teachers don\'t use a single prescribed textbook because the objective is different: the programme is designed to develop the ability to use knowledge in new situations, not to recognise content on a standardised exam. Research in learning science consistently shows that students who must form and test their own reasoning retain understanding far longer than students who receive and repeat a teacher\'s explanation. The investigation is not a substitute for learning. It is a more cognitively demanding form of it. The 素质教育 (quality education) reform debate has been precisely about this: whether 应试教育 (exam-oriented education) produces graduates who can function in research and professional environments, or only in exam halls. China\'s 双减 (double reduction) policy, introduced in July 2021 to cut after-school tutoring and reduce homework loads in national schools, was a direct government response to this finding — the conclusion that drill-based learning was producing diminishing returns and crowding out broader development. The IB\'s inquiry model is not a foreign alternative to Chinese education values; it runs parallel to the direction China\'s own policymakers concluded national education needed to move.',
        ...
        ibConnection: 'The IB Learner Profile attributes — particularly "inquirers," "thinkers," and "reflective" — are not peripheral values. They describe the dispositions the programme is engineered to build over years of practice. Research published in Frontiers in Education (2025) examined specifically whether Confucian learning ethics are compatible with autonomous, inquiry-based learning — and found that they are, when learning is purposefully structured. Confucian values — commitment to effort (努力), reflection (反思), and treating learning as a moral project — align well with IB pedagogy. The gap is not between Chinese education culture and inquiry learning; it is between exam-drilling and all other approaches.',
        whatToAsk: [
      ...
      zh: {
        ...
        bridge: 'IB教师不使用统一的教材，因为目标不同：该课程旨在培养在新情境中运用知识的能力，而不是在标准化考试中识别内容。学习科学研究一贯表明，必须自己形成和检验推理的学生，其理解的保留时间远超那些接受并重复教师讲解的学生。探究不是学习的替代品，而是认知要求更高的学习形式。素质教育改革讨论的核心正是这一点：应试教育是否能培养出在研究和职业环境中胜任的毕业生，还是只能在考场上表现出色。中国2021年7月颁布的双减政策——削减课外补习时间、减轻国家课程学生的作业负担——正是政府对这一研究结论的直接回应：以刷题为核心的学习模式收益递减，并挤占了更广泛能力的发展空间。IB的探究模式并非对中国教育价值观的外来替代；它与中国决策者所得出的国家教育改革方向相互呼应。',
        goal: '全球最具竞争力的大学正在寻找能够参与研究、处理模糊问题、超越已学内容进行思考的学生。一个多年来练习提问和检验想法的学生，在牛津面试、哈佛申请文书或研究研讨会中，往往能做到只刷真题的学生所无法企及的事。',
        ibConnection: 'IB学习者素养——尤其是"探究者"、"思考者"和"反思者"——不是边缘性的价值观。它们描述的是该课程经过多年实践工程化培养的心理倾向。2025年发表于《教育前沿》（Frontiers in Education）的研究专门考察了儒家学习伦理是否与IB所要求的自主探究式学习相兼容——结论是：当学习有目的性地构建时，两者是兼容的。儒家学习价值观——对努力的重视、对反思的强调、将学习视为道德实践——与IB教学法高度契合。文化差距并不存在于中国教育文化与探究式学习之间；它存在于以刷题备考为核心的应试训练与其他所有学习方式之间。',
        whatToAsk: [
    ...
    },
    {
      ...
      en: {
        ...
        goal: 'CAS is not a factor in domestic Chinese admissions processes. Its value is the diploma it completes and the skills it builds. For international university applications it is actively considered — and the resilience, leadership capacity, and ability to manage competing commitments it develops are what determine success after university admission, for decades beyond.',
      ...
      zh: {
        ...
        goal: 'CAS在国内招生流程中没有直接权重，其价值在于它所完成的文凭和培养的技能。对于国际大学申请，CAS被积极考量——它所培养的韧性、领导能力和管理多项任务的能力，是决定大学录取后长期成功的核心品质。',
  ...
  pypCards: [
    ...
    },
    {
      ...
      en: {
        ...
        bridge: 'In PYP Early Years (ages 3–6), structured play is the curriculum — not a break from it. Children develop language, mathematical thinking, social reasoning, and inquiry skills through purposeful, teacher-designed activities. Both the IB and decades of developmental research agree: formal academic instruction before age 6–7 does not produce better long-term outcomes and often produces worse ones by undermining the intrinsic motivation that sustains learning over time. China\'s 双减 (double reduction) policy, enacted in July 2021, reflects exactly this tension at national scale. The policy cut after-school tutoring hours and capped homework loads in compulsory education — motivated by the same evidence base that underpins PYP Early Years design. Research published in SAGE Journals (Chen and Lin, 2024) found that 双减 was designed specifically to shift Chinese education away from exam-pressure and toward balanced, quality development — the same shift PYP was built around decades earlier. That China\'s own policymakers reached the same conclusion as the IB Organisation is not a coincidence; both were responding to the same body of developmental research. IB schools operate in a separate regulatory space from the national curriculum and were not constrained by 双减.',
        ...
        ibConnection: 'PYP Early Years is aligned with international early childhood research, including OECD evidence on school readiness and the developmental frameworks underpinning Finland\'s early education system. Chen and Lin (2024, SAGE Journals) document that 双减\'s core intent — reducing exam-oriented pressure and building balanced, whole-person capabilities — draws directly on the same developmental research the IB uses. Both reach the same conclusion: early academic drilling is not a reliable investment in long-term learning outcomes, and developing intrinsic motivation is.',
        whatToAsk: [
      ...
      zh: {
        ...
        bridge: '在PYP低幼年段（3–6岁），有结构的游戏就是课程本身——不是课程的休息时间。孩子通过有目的性的、由教师设计的活动发展语言、数学思维、社会推理和探究技能。IB和数十年的发展研究都认同：6–7岁以前的正式学业教学不会产生更好的长期结果，往往还会产生更差的结果，因为它会破坏维持长期学习的内在动力。中国2021年7月颁布的双减政策，正是在国家层面对这一矛盾的直接回应。该政策削减了义务教育阶段的课外补习时间，限制了作业负担——其依据的研究基础与PYP低幼年段的设计原理如出一辙。发表于SAGE期刊的研究（陈和林，2024年）发现，双减的核心目标正是推动中国教育从应试压力转向均衡、优质的全面发展——这与PYP多年前所追求的转变完全一致。中国决策者与IB组织得出相同结论并非巧合；两者都是在回应同一套发展研究体系。值得注意的是：双减颁布后，地下补习市场随之兴起，因为中考和高考的压力并未消失。IB学校在单独的监管空间内运营，但家庭感受到的外部压力是真实存在的——本指南正是在充分理解这一压力的前提下撰写的。',
        goal: '在低幼年段通过有目的的游戏学习的孩子，比那些过早接受正式学业教育的孩子，能发展出更强的自我调节能力、创造力和内在动力。这些品质能够预测整个中学乃至更长远的学业成功——而且一旦在早期压力中失去，就很难再培养回来。',
        ibConnection: 'PYP低幼年段与国际幼儿教育研究相一致，包括OECD关于入学准备的证据和芬兰早期教育体系的发展框架。陈和林（2024年，SAGE期刊）记录了双减的核心意图——减少应试压力、培养均衡的全人发展能力——直接来源于IB所依赖的同一套发展研究体系。两者得出了相同的结论：早期以刷题为核心的学业训练并不是对长期学习成果的可靠投入，而培养内在学习动力才是。',
        whatToAsk: [
