export const uaeIbParent = {
  ...
  meta: {
    en: {
      ...
      khdaContext: 'Useful context for parents comparing schools: KHDA (Dubai) and ADEK (Abu Dhabi) publish transparent annual inspection ratings for every school — Outstanding, Very Good, Good, Acceptable, Weak, Very Weak — and the criteria they use closely align with what the research on school effectiveness identifies as the real drivers of outcomes: teaching quality, assessment and feedback practices, pastoral care, leadership, and student wellbeing. When you read an inspection report, look especially at the "Teaching and assessment" and "Students\' personal and social development" sections. These are the signals that correlate with student experience. The overall rating alone can miss meaningful differences between schools of the same rating tier. The inspection framework itself — built on international school-effectiveness research (Hattie, Robinson, Fullan) — is one of the most sophisticated regulatory systems for schools anywhere in the world, and it gives UAE parents better school-quality information than parents in most countries have access to.',
      researchAnchor: 'One piece of research worth holding in mind as you weigh the IB vs EmSAT question: the Education Endowment Foundation\'s Teaching and Learning Toolkit (a UK government-funded meta-review) consistently identifies metacognition and self-regulation, feedback, and collaborative learning as among the highest-leverage interventions — each associated with roughly 7–8 months of additional progress per year. These are the competencies the IB programme is explicitly designed to build. EmSAT, by contrast, measures what students know on a specific exam day. Both signals matter; the evidence suggests the IB competencies are the more durable predictor of university and professional success beyond entry.',
    },
    ar: {
