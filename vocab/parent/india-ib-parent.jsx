...
export const indiaIbParent = {
  ...
  meta: {
    en: {
      ...
      reassurance: 'One thing that does not change: your child is still learning Mathematics, Science, and Languages to a high standard. The content depth in IB Mathematics and Sciences at MYP and DP level is comparable to CBSE Class 9–12 — the IB is not a lighter curriculum, it is a differently demanding one. Your child is still being rigorously assessed on every major piece of work they submit. The differences are in how learning is structured and how progress is reported — not in whether rigour exists.',
      indianUniversityNote: 'For families in India or considering return: Indian universities have varied IB policies. The University of Delhi, BITS Pilani, Ashoka University, and many private institutions accept IB scores directly. However, engineering entrance (JEE) and medicine entrance (NEET) present a genuine content trade-off. IB Diploma holders are formally eligible to sit JEE Main — NTA accepts the IB Diploma as a Class 12 equivalent when students hold an AIU (Association of Indian Universities) equivalency certificate and have studied Physics, Chemistry, and Mathematics at Higher Level. The challenge is content alignment, not eligibility: JEE and NEET test specific problem-solving patterns and syllabus sequences that IB HL courses approach differently. Families keeping both pathways open need to address this by Year 9 — supplementary coaching in JEE/NEET content patterns is the most common strategy. If JEE or NEET is a possibility, that conversation with your school counsellor needs to happen now, not in Year 11. Most Indian IB students target UK, US, Australian, or Canadian universities where the IB Diploma is well recognised. Your school\'s university counsellor can advise on current Indian acceptance policies.',
