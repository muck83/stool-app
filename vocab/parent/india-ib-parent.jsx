...
export const indiaIbParent = {
  ...
  meta: {
    en: {
      ...
      reassurance: 'One thing that does not change: your child is still learning Mathematics, Science, and Languages to a high standard. They are still being rigorously assessed on every major piece of work they submit. They are still being prepared for university entrance. The differences are in how learning is structured and how progress is reported — not in whether rigour exists.',
      indianUniversityNote: 'For families in India or considering return: Indian universities have varied IB policies. The University of Delhi, BITS Pilani, Ashoka University, and many private institutions accept IB scores directly. However, engineering entrance (JEE) and medicine entrance (NEET) require specific preparation that the IB curriculum does not cover — this is a genuine trade-off if those pathways matter to your family. Most Indian IB students target UK, US, Australian, or Canadian universities where the IB Diploma is well recognised. Your school\'s university counsellor can advise on current Indian acceptance policies.',
    },
  },
  ...
  cards: [
    {
      ...
      en: {
        ...
        bridge: 'IB teachers don\'t use a single prescribed textbook because the goal is different: understanding how to use knowledge, not recognising content on an exam. Research consistently shows that students who wrestle with a problem — who must form and test their own reasoning — retain understanding far longer than students who memorise a teacher\'s explanation. The investigation is not a substitute for learning. It is a more demanding form of it.',
        goal: 'Top UK and US universities, and demanding Indian institutions like IIMA, directly test the ability to think through problems that haven\'t been seen before. Inquiry-based learning is daily practice for exactly that. A student who has spent years forming questions and testing ideas can handle an Oxford interview, a case study, or a first-year university research project in ways that a student who memorised the syllabus often cannot.',
        ibConnection: 'The IB describes students as "inquirers" — curiosity and independent thinking are not peripheral skills. They are what the programme is designed to build.',
        whatToAsk: [
    ...
    },
    {
      ...
      en: {
        ...
        goal: 'UK universities — particularly Oxbridge and Russell Group institutions — read Extended Essays during application review. A student who has genuinely engaged with independent research brings something to a personal statement and interview that exam marks alone cannot demonstrate. This is a material advantage in competitive applications.',
    ...
    },
    {
      ...
      en: {
        ...
        goal: 'CAS also develops what no textbook or coaching centre can build: resilience, the ability to manage competing commitments, and the capacity to work with people unlike yourself. These are the qualities that determine whether a student succeeds after university admission — and that employers value for decades after graduation. They are much harder to develop once the pressure of structured schooling is gone.',
  ...
  pypCards: [
    ...
    },
    {
      ...
      en: {
        ...
        ibConnection: 'PYP Early Years is aligned with international research on early childhood development, including evidence from Finland\'s education system and the Reggio Emilia approach.',
        whatToAsk: [
  ...
  gradingSystem: {
    myp: {
      en: {
        ...
        descriptors: [
          { grade: 1, label: 'Minimal achievement',      ko: 'Minimal achievement' },
          { grade: 2, label: 'Very limited achievement', ko: 'Very limited achievement' },
          { grade: 3, label: 'Limited achievement',      ko: 'Limited achievement' },
          { grade: 4, label: 'Adequate achievement',     ko: 'Adequate achievement' },
          { grade: 5, label: 'Substantial achievement',  ko: 'Substantial achievement' },
          { grade: 6, label: 'Accomplished achievement', ko: 'Accomplished achievement' },
          { grade: 7, label: 'Excellent achievement',    ko: 'Excellent achievement' },
        ],
        boundaries: [
          { grade: 1, min: 0,  max: 5  },
          { grade: 2, min: 6,  max: 9  },
  ...
  nextSteps: {
    en: {
      ...
      'myp-dp': [
        'Open the DP Calculator and set your child\'s predicted grades. Check whether any subject is at risk of failing a diploma condition — this is more urgent than total points.',
        ...
        'If JEE, NEET, or other Indian entrance examinations are relevant to your family\'s plans, speak with the school\'s university counsellor now — not in Year 12. The IB DP curriculum does not align with those exam formats and the trade-offs need to be understood early.',
      ],
    },
  },
