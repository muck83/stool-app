  ...
  cards: [
    ...
    },
    {
      ...
      en: {
        ...
        bridge: 'Vietnam\'s Ministry of Education and Training (MOET) has formal recognition pathways for IB and AP graduates. Several leading Vietnamese universities — including Vietnam National University Hanoi and HCMC — have direct admission tracks for international school graduates with IB or AP credentials. Beyond Vietnam: IB Diploma graduates from ISHCMC, BIS Vietnam, and BVIS Vietnam have been admitted to UCL, Warwick, Melbourne, ANU, NYU, Emory, and dozens of ranked US schools. AP students from AIS Saigon and ACIS have similarly strong track records to US universities. The overseas pathway is not theoretical — it is being taken by students at your child\'s school right now.',
  ...
  pypCards: [
    {
      id: 'pyp-001',
      en: {
        title: 'What PYP actually teaches',
        body: 'PYP (Primary Years Programme) is for students aged 3–12. It is structured around six transdisciplinary themes — Who We Are, Where We Are in Place and Time, How We Express Ourselves, How the World Works, How We Organise Ourselves, Sharing the Planet. Within each theme, students inquire into real questions: Why do people migrate? How do ecosystems change? What makes a system fair? The academic content — Mathematics, Language, Science, Social Studies, Arts — is taught inside these inquiries, not as separate drills.',
        contrast: 'Vietnamese national primary schools use a subject-by-subject approach with defined content chapters, regular dictation (đọc chính tả), memory recall tests, and a clear performance ranking. PYP does none of these things visibly. This does not mean content is absent — it means content is embedded in inquiry. A child studying "How ecosystems change" is still learning Science curriculum. The difference is that they are learning it by investigating a question, not by reading a chapter and taking a test.',
        parentSignal: 'The best signal of PYP learning is not a grade — it is the questions your child asks at home. "Why do some countries have more resources?" "How did this neighbourhood look different 50 years ago?" "What would happen if we stopped using plastic?" These are PYP in action.',
      },
      vi: {
        title: 'PYP thực sự dạy gì',
        body: 'PYP (Chương trình Tiểu học) dành cho học sinh từ 3–12 tuổi. Chương trình được cấu trúc xung quanh sáu chủ đề liên môn — Chúng Ta Là Ai, Chúng Ta Ở Đâu Trong Không Gian Và Thời Gian, Cách Chúng Ta Thể Hiện Bản Thân, Thế Giới Hoạt Động Như Thế Nào, Cách Chúng Ta Tổ Chức Bản Thân, Chia Sẻ Hành Tinh. Trong mỗi chủ đề, học sinh tìm hiểu về các câu hỏi thực: Tại sao mọi người di cư? Hệ sinh thái thay đổi như thế nào? Điều gì làm cho một hệ thống công bằng? Nội dung học thuật — Toán học, Ngôn ngữ, Khoa học, Khoa học Xã hội, Nghệ thuật — được dạy trong các cuộc điều tra này, không phải như các bài tập riêng biệt.',
        contrast: 'Trường tiểu học quốc gia Việt Nam sử dụng phương pháp từng môn với các chương nội dung được xác định, đọc chính tả thường xuyên, bài kiểm tra ghi nhớ và xếp hạng kết quả rõ ràng. PYP không làm bất kỳ điều nào trong số này một cách rõ ràng. Điều này không có nghĩa là nội dung vắng mặt — có nghĩa là nội dung được nhúng vào quá trình tìm hiểu. Một đứa trẻ nghiên cứu "Hệ sinh thái thay đổi như thế nào" vẫn đang học nội dung Khoa học. Sự khác biệt là chúng học bằng cách điều tra một câu hỏi, không phải bằng cách đọc một chương và làm bài kiểm tra.',
        parentSignal: 'Tín hiệu tốt nhất của việc học PYP không phải là điểm số — mà là những câu hỏi con bạn hỏi ở nhà. "Tại sao một số quốc gia có nhiều tài nguyên hơn?" "Khu phố này trông như thế nào 50 năm trước?" "Điều gì sẽ xảy ra nếu chúng ta ngừng sử dụng nhựa?" Đây là PYP đang hoạt động.',
      },
    },
    {
      id: 'pyp-002',
      en: {
        title: 'Vietnamese language in PYP',
        body: 'Most IB schools in Vietnam offer Vietnamese Language as a school-supported language (Language B at PYP level, Language A or B at MYP/DP level). At ISHCMC, BIS Vietnam, and BVIS, Vietnamese is taught as a formal curriculum subject throughout. At schools where the student body is mostly non-Vietnamese, Vietnamese may be offered as an additional language course.',
        contrast: 'The concern that your child will lose Vietnamese language proficiency at an international school is real and worth monitoring — but it is addressable. Schools with strong Vietnamese Language A programmes teach the language at the same literary depth as the Vietnamese national curriculum. If your school offers Vietnamese A, your child\'s Vietnamese literacy should remain strong. If only Vietnamese B is available, the literary depth will be lower. Ask the school which programme level is offered.',
        parentSignal: 'Read to your child in Vietnamese at home throughout PYP and MYP. Maintain family conversations in Vietnamese. The combination of Vietnamese Language A at school plus a Vietnamese-speaking home environment produces genuinely bilingual children — which is itself a significant advantage in university applications.',
      },
      vi: {
        title: 'Tiếng Việt trong PYP',
        body: 'Hầu hết các trường IB tại Việt Nam cung cấp Tiếng Việt như một ngôn ngữ được trường hỗ trợ (Ngôn ngữ B ở cấp độ PYP, Ngôn ngữ A hoặc B ở cấp độ MYP/DP). Tại ISHCMC, BIS Vietnam và BVIS, Tiếng Việt được dạy như một môn học chính thức trong suốt chương trình. Tại các trường có học sinh chủ yếu không phải người Việt, Tiếng Việt có thể được cung cấp như một khóa học ngoại ngữ bổ sung.',
        contrast: 'Lo ngại rằng con bạn sẽ mất khả năng thành thạo tiếng Việt tại một trường quốc tế là có thực và đáng được theo dõi — nhưng có thể giải quyết được. Các trường có chương trình Tiếng Việt A mạnh dạy ngôn ngữ ở độ sâu văn học tương tự như chương trình quốc gia Việt Nam. Nếu trường của bạn cung cấp Tiếng Việt A, khả năng đọc viết tiếng Việt của con bạn sẽ vẫn mạnh. Nếu chỉ có Tiếng Việt B, độ sâu văn học sẽ thấp hơn. Hỏi trường cấp độ chương trình nào được cung cấp.',
        parentSignal: 'Đọc cho con nghe bằng tiếng Việt ở nhà trong suốt PYP và MYP. Duy trì các cuộc trò chuyện gia đình bằng tiếng Việt. Sự kết hợp của Tiếng Việt A ở trường cộng với môi trường gia đình nói tiếng Việt tạo ra những đứa trẻ thực sự song ngữ — điều này tự nó là một lợi thế đáng kể trong đơn xin học đại học.',
      },
    },
    {
      id: 'pyp-003',
      en: {
        title: 'How PYP reports work',
        body: 'PYP reports do not give numerical grades. Instead, they describe the student\'s learning using the IB Learner Profile attributes (Inquirer, Knowledgeable, Thinker, Communicator, Principled, Open-minded, Caring, Risk-taker, Balanced, Reflective) and narrative comments by subject teachers. Some schools also include ratings on approaches to learning — research skills, communication skills, self-management skills, social skills, thinking skills.',
        contrast: 'This is the starkest difference from Vietnamese national school reports, which give numerical điểm số for each subject and a clear overall classification (giỏi / khá / trung bình). A Vietnamese parent reading a PYP report for the first time often feels it says nothing concrete. It is not designed to say "your child is a 7.5 in Maths." It is designed to say "here is what your child can and cannot yet do, and here is what we are working on together." The measure of a strong PYP year is not a grade — it is growth.',
        parentSignal: 'After receiving a PYP report, schedule a 15-minute conversation with the class teacher. Ask: "What is one thing my child does confidently? What is one thing we can work on together at home?" Most PYP teachers welcome this conversation and will be specific.',
      },
      vi: {
        title: 'Cách báo cáo PYP hoạt động',
        body: 'Báo cáo PYP không đưa ra điểm số. Thay vào đó, chúng mô tả việc học của học sinh bằng cách sử dụng các thuộc tính Hồ sơ Học sinh IB (Người tìm hiểu, Người có kiến thức, Người suy nghĩ, Người giao tiếp, Người có nguyên tắc, Người có tư duy rộng mở, Người quan tâm, Người dám chấp nhận rủi ro, Người cân bằng, Người phản ánh) và nhận xét tường thuật của giáo viên. Một số trường cũng bao gồm đánh giá về phương pháp tiếp cận học tập — kỹ năng nghiên cứu, kỹ năng giao tiếp, kỹ năng tự quản lý, kỹ năng xã hội, kỹ năng tư duy.',
        contrast: 'Đây là sự khác biệt nổi bật nhất so với báo cáo trường quốc gia Việt Nam, nơi đưa ra điểm số cho mỗi môn học và phân loại tổng thể rõ ràng (giỏi / khá / trung bình). Một phụ huynh Việt Nam đọc báo cáo PYP lần đầu thường cảm thấy nó không nói được gì cụ thể. Nó không được thiết kế để nói "con bạn được 7.5 môn Toán". Nó được thiết kế để nói "đây là những gì con bạn có thể và chưa thể làm, và đây là những gì chúng tôi đang làm việc cùng nhau." Thước đo của một năm PYP tốt không phải là điểm số — mà là sự tăng trưởng.',
        parentSignal: 'Sau khi nhận báo cáo PYP, hãy lên lịch một cuộc trò chuyện 15 phút với giáo viên. Hỏi: "Một điều con tôi tự tin làm là gì? Một điều chúng ta có thể cùng nhau làm việc ở nhà là gì?" Hầu hết giáo viên PYP đều hoan nghênh cuộc trò chuyện này và sẽ cụ thể.',
      },
    },
    {
      id: 'pyp-004',
      en: {
        title: 'The PYP Exhibition',
        body: 'In the final year of PYP (typically Year 5/Grade 5, ages 10–11), students complete the PYP Exhibition: an independent inquiry project on a real-world issue that they have chosen and researched over several months. It is presented publicly — to parents, teachers, and invited guests. The Exhibition is the culminating assessment of the entire PYP journey.',
        contrast: 'The Exhibition is very different from the end-of-year exams Vietnamese families are familiar with. It is not a memory test. It is a demonstration of the student\'s ability to identify a problem, research it using multiple sources, connect it to transdisciplinary themes, and communicate findings to an audience. Students who do this well at age 10 are genuinely ahead of their peers for DP Internal Assessments and university-level work at age 18.',
        parentSignal: 'When the Exhibition is scheduled, attend. It is not optional or ceremonial — it is the single best opportunity to see your child\'s capacity for independent inquiry. Ask your child beforehand: "What is your Exhibition question? Why did you choose it? What have you found out that surprised you?"',
      },
      vi: {
        title: 'Triển lãm PYP',
        body: 'Trong năm cuối của PYP (thường là Năm 5/Lớp 5, 10–11 tuổi), học sinh hoàn thành Triển lãm PYP: một dự án tìm hiểu độc lập về một vấn đề thực tế mà chúng đã chọn và nghiên cứu trong vài tháng. Nó được trình bày công khai — cho phụ huynh, giáo viên và khách mời. Triển lãm là bài đánh giá kết thúc của toàn bộ hành trình PYP.',
        contrast: 'Triển lãm rất khác so với các kỳ thi cuối năm mà các gia đình Việt Nam quen thuộc. Đó không phải là bài kiểm tra trí nhớ. Đó là sự thể hiện khả năng của học sinh trong việc xác định một vấn đề, nghiên cứu nó bằng nhiều nguồn, kết nối với các chủ đề liên môn và truyền đạt kết quả cho khán giả. Học sinh làm tốt điều này ở tuổi 10 thực sự đi trước bạn bè của mình cho Đánh giá Nội bộ DP và công việc cấp đại học ở tuổi 18.',
        parentSignal: 'Khi Triển lãm được lên lịch, hãy tham dự. Đó không phải là tùy chọn hay nghi lễ — đó là cơ hội tốt nhất để xem khả năng tìm hiểu độc lập của con bạn. Hỏi con trước: "Câu hỏi Triển lãm của con là gì? Tại sao con chọn câu hỏi đó? Con đã phát hiện ra điều gì khiến con ngạc nhiên?"',
      },
    },
    {
      id: 'pyp-005',
      en: {
        title: 'Homework, tutoring (học thêm), and PYP',
        body: 'Vietnamese families often ask whether học thêm (extra tutoring outside school) is appropriate for PYP children. The honest answer: it depends entirely on what kind of tutoring. Drilling Maths facts (times tables, mental arithmetic) and building strong reading habits in Vietnamese and English are genuinely useful at PYP age. Cramming textbook chapters or rote-memorising content for a test that does not exist at IB schools is not useful and may create confusion.',
        contrast: 'PYP teachers sometimes notice that heavily tutored Vietnamese students can recall facts quickly but struggle to apply them in open-ended tasks. This is the opposite of what PYP assessment values. A student who understands why 6×7=42 rather than only that it equals 42 will perform better in MYP than a student who has drilled the table 200 times.',
        parentSignal: 'If you want to support your child\'s learning at home during PYP: read together every evening (Vietnamese and English), do real-world Maths (cooking measurements, shopping budgets, telling time), discuss the unit of inquiry theme at dinner. These activities align with PYP far better than traditional tutoring.',
      },
      vi: {
        title: 'Bài tập về nhà, học thêm và PYP',
        body: 'Các gia đình Việt Nam thường hỏi liệu học thêm (dạy thêm bên ngoài trường) có phù hợp cho trẻ PYP không. Câu trả lời thực tế: điều đó hoàn toàn phụ thuộc vào loại học thêm. Luyện tập các sự kiện Toán học (bảng nhân, tính toán tâm trí) và xây dựng thói quen đọc tốt bằng tiếng Việt và tiếng Anh thực sự hữu ích ở độ tuổi PYP. Nhồi nhét các chương sách giáo khoa hoặc ghi nhớ máy móc nội dung cho một bài kiểm tra không tồn tại ở các trường IB là không hữu ích và có thể gây nhầm lẫn.',
        contrast: 'Giáo viên PYP đôi khi nhận thấy rằng học sinh Việt Nam được học thêm nhiều có thể nhớ lại sự kiện nhanh chóng nhưng gặp khó khăn khi áp dụng chúng vào các nhiệm vụ mở. Đây là điều ngược lại với những gì đánh giá PYP đánh giá. Một học sinh hiểu tại sao 6×7=42 hơn là chỉ biết nó bằng 42 sẽ thực hiện tốt hơn trong MYP so với học sinh đã luyện bảng 200 lần.',
        parentSignal: 'Nếu bạn muốn hỗ trợ việc học của con ở nhà trong PYP: đọc cùng nhau mỗi tối (tiếng Việt và tiếng Anh), thực hành Toán thực tế (đo lường trong nấu ăn, ngân sách mua sắm, đọc giờ), thảo luận về chủ đề đơn vị tìm hiểu trong bữa tối. Những hoạt động này phù hợp với PYP hơn nhiều so với học thêm truyền thống.',
      },
    },
  ],
  ...
  gradingSystem: {
    myp: {
      en: {
        ...
        intro: 'MYP subject grades run from 1 to 7. The grade is derived from four criterion scores (each 0–8), which are added and then converted using a grade boundary table. The table is recalibrated each year. Do not convert MYP grades to a percentage — the boundary positions shift.',
        note: 'In Vietnam, parents sometimes try to map MYP grades to the Vietnamese thang điểm 10 by multiplying by 10/7. This gives: Grade 7 = 10, Grade 6 = 8.6, Grade 5 = 7.1, Grade 4 = 5.7. This mapping is educationally incorrect and will misrepresent your child\'s achievement. A Grade 5 is not 7.1 — it is Substantial Achievement against externally verified criteria.',
      },
      vi: {
        title: 'Mô tả điểm MYP',
        intro: 'Điểm môn học MYP chạy từ 1 đến 7. Điểm được tính từ bốn điểm tiêu chí (mỗi điểm từ 0–8), được cộng lại và sau đó chuyển đổi bằng bảng giới hạn điểm. Bảng được hiệu chỉnh lại mỗi năm. Đừng quy đổi điểm MYP thành phần trăm — vị trí giới hạn thay đổi.',
        note: 'Ở Việt Nam, phụ huynh đôi khi cố gắng ánh xạ điểm MYP sang thang điểm 10 của Việt Nam bằng cách nhân với 10/7. Điều này cho: Điểm 7 = 10, Điểm 6 = 8.6, Điểm 5 = 7.1, Điểm 4 = 5.7. Ánh xạ này về mặt giáo dục là không chính xác và sẽ hiểu sai thành tích của con bạn. Điểm 5 không phải là 7.1 — đó là Thành tích Đáng kể theo tiêu chí được kiểm tra bên ngoài.',
      },
      descriptors: [
    ...
    dp: {
      en: {
        ...
        watchOut: 'Do not confuse IB predicted grades with actual exam grades. Universities make offers based on predicted grades (provided by teachers in Year 12). If your child\'s actual exam results fall significantly below predicted grades, some offers may be withdrawn. The school counsellor manages this process — ensure predicted grades are realistic and based on current evidence.',
        universityContext: 'For Việt Nam-based students targeting overseas universities: IB 36+ is competitive for Russell Group UK, Go8 Australia, and top-40 US schools. IB 38+ opens doors to UCL, Warwick, and the lower tier of Oxbridge. IB 40+ is competitive for Oxford, Cambridge, Imperial. AP 4–5 in 5+ subjects is competitive for the same tier. The critical factor is not the number alone — it is the combination of scores, subject choices, and the application narrative (personal statement / Common App essay).',
      },
      vi: {
        ...
        watchOut: 'Đừng nhầm lẫn điểm dự đoán IB với điểm thi thực tế. Các trường đại học đưa ra đề nghị dựa trên điểm dự đoán (do giáo viên cung cấp vào năm 12). Nếu kết quả thi thực tế của con bạn giảm đáng kể so với điểm dự đoán, một số đề nghị có thể bị rút lại. Cố vấn học đường quản lý quy trình này — đảm bảo điểm dự đoán là thực tế và dựa trên bằng chứng hiện tại.',
        universityContext: 'Đối với học sinh ở Việt Nam nhắm đến các trường đại học nước ngoài: IB 36+ cạnh tranh cho Russell Group Anh, Go8 Úc và các trường top-40 Mỹ. IB 38+ mở cửa cho UCL, Warwick và tầng thấp hơn của Oxbridge. IB 40+ cạnh tranh cho Oxford, Cambridge, Imperial. AP 4–5 trong 5+ môn cạnh tranh cho cùng cấp độ. Yếu tố quan trọng không chỉ là con số đơn thuần — mà là sự kết hợp của điểm số, lựa chọn môn học và câu chuyện đơn xin học (bản tự giới thiệu / bài luận Common App).',
      },
    },
  },
  ...
  nextSteps: {
    en: {
      default: {
        ...
        body: 'The most useful single action after reading this guide is to schedule a meeting with your child\'s form tutor or advisor and ask for one specific thing: "Can you show me where my child currently stands on each subject criterion, and what one improvement would make the most difference to their predicted grade?" That question, asked once a semester, is the most effective parental action in IB and AP schools.',
      },
      new: {
        title: 'You\'re new to IB — start here',
        steps: [
          'Request the criterion rubrics for two subjects your child finds most challenging. Read them.',
          'Ask the school counsellor: "What is the overseas university profile of recent graduates from this school?"',
      ...
      settled: {
        title: 'You\'re settling in — these are your priorities',
        steps: [
          'Use the MYP calculator in the Grade System section to re-read the most recent report.',
          ...
          'Check CAS logs: ask your child to show you their current CAS tracker.',
          'If your child is in Year 10: subject selection is urgent. Schedule a counsellor meeting before the selection deadline.',
        ],
      },
      'pyp-myp': {
        title: 'Your child is moving from PYP to MYP',
        steps: [
          'Read the PYP section of this guide to understand what skills PYP has been building.',
          'Ask the Year 5 teacher: "Which of the MYP approaches to learning does my child need to work on most?"',
          'Review Vietnamese Language level with the language teacher: is your child in Language A or Language B?',
      ...
      'myp-dp': {
        title: 'Your child is moving from MYP to DP — this is critical',
        steps: [
          'Schedule a subject selection meeting before the end of Year 10. Bring your child\'s MYP criterion scores and a clear sense of their university destination.',
          'Research prerequisite subjects for the target university and programme. Do not select HL subjects without confirming prerequisites.',
          'Clarify the overseas university counselling service: Does the school have a dedicated counsellor? What is their track record for Vietnam-based students?',
          'Discuss TOK and Extended Essay early: what topics is your child interested in? The best EE topics are chosen at the start of Year 11, not in Year 12.',
        ],
      },
    },
    vi: {
      default: {
        ...
        body: 'Hành động hữu ích nhất sau khi đọc hướng dẫn này là lên lịch một cuộc họp với giáo viên chủ nhiệm hoặc cố vấn của con bạn và yêu cầu một điều cụ thể: "Bạn có thể cho tôi xem vị trí hiện tại của con tôi trên từng tiêu chí môn học, và một cải tiến nào sẽ tạo ra sự khác biệt lớn nhất cho điểm dự đoán của con không?" Câu hỏi đó, được hỏi mỗi học kỳ một lần, là hành động hiệu quả nhất của phụ huynh trong các trường IB và AP.',
      },
      new: {
        title: 'Bạn mới làm quen với IB — bắt đầu ở đây',
        steps: [
          'Yêu cầu bảng tiêu chí đánh giá cho hai môn học con bạn thấy khó khăn nhất. Hãy đọc chúng.',
          'Hỏi cố vấn học đường: "Hồ sơ đại học nước ngoài của học sinh tốt nghiệp gần đây từ trường này là gì?"',
      ...
      settled: {
        title: 'Bạn đang ổn định — đây là những ưu tiên của bạn',
        steps: [
          'Sử dụng máy tính MYP trong phần Hệ thống điểm để đọc lại bảng điểm gần nhất.',
          ...
          'Kiểm tra nhật ký CAS: yêu cầu con bạn cho bạn xem bộ theo dõi CAS hiện tại của con.',
          'Nếu con bạn đang ở năm 10: lựa chọn môn học rất cấp bách. Lên lịch cuộc họp với cố vấn trước hạn chót lựa chọn.',
        ],
      },
      'pyp-myp': {
        title: 'Con bạn đang chuyển từ PYP sang MYP',
        steps: [
          'Đọc phần PYP của hướng dẫn này để hiểu những kỹ năng PYP đã xây dựng.',
          'Hỏi giáo viên năm 5: "Trong số các cách tiếp cận học tập MYP, con tôi cần làm việc nhiều nhất ở đâu?"',
          'Xem lại cấp độ Tiếng Việt với giáo viên ngôn ngữ: con bạn đang học Ngôn ngữ A hay Ngôn ngữ B?',
          'Đặt kỳ vọng với đại gia đình: điểm MYP trông khác so với điểm trường Việt Nam. Chia sẻ bảng mô tả điểm với ông bà nếu cần.',
        ],
      },
      'myp-dp': {
        title: 'Con bạn đang chuyển từ MYP sang DP — điều này rất quan trọng',
        steps: [
          ...
          'Nghiên cứu các môn học tiên quyết cho trường đại học và chương trình mục tiêu. Đừng chọn môn HL mà không xác nhận các điều kiện tiên quyết.',
          'Làm rõ dịch vụ tư vấn đại học nước ngoài: Trường có cố vấn chuyên dụng không? Thành tích của họ đối với học sinh có căn cứ ở Việt Nam là gì?',
