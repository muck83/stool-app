...
export const vietnamIbParent = {
  ...
  meta: {
    en: {
      ...
      reassurance: 'One thing that does not change: your child is still learning Mathematics, Sciences, and Languages to a high standard. IB HL Mathematics and Sciences are among the most rigorous curricula at secondary level anywhere in the world. AP Calculus BC, AP Chemistry, and AP Physics C are similarly demanding. The differences are in how learning is structured, how assessment works, and how progress is reported — not in whether rigour exists. On Vietnamese language: IB schools offer Vietnamese Language and Literature (Vietnamese A) for native Vietnamese speakers, taught as a serious literature course with classical and modern Vietnamese texts, critical essay writing, and oral commentary. Your child\'s Vietnamese does not have to stop at the school gate. One piece of context Vietnamese parents can be proud of: Vietnam\'s performance on PISA — the OECD\'s global assessment of 15-year-olds — has consistently ranked Vietnam well above what its GDP per capita would predict, outperforming many OECD countries in mathematics and science and prompting a sustained international research literature on why (strong teacher quality, engaged parents, clear curriculum sequencing, and high academic expectations are the factors most often identified). The implication for an IB or AP classroom in Vietnam: the academic baseline your child brings from family and cultural expectations is a genuine asset. The IB is not asking your child to start from zero — it is asking your child to take a strong foundation and apply it to more open, investigative work.',
