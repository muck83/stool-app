...
export const counselorIb = {
  ...
  // ─── Research anchors: what to say in the room, backed by evidence ─────
  researchAnchors: [
    {
      id: 'anchor-feedback',
      topic: 'Feedback vs tutoring',
      folkBelief: 'When a student slips, the solution is more hours — more homework, another tutor, a holiday intensive.',
      evidence: "Hattie's Visible Learning (2023 update, 2,100+ meta-analyses) puts feedback at d ≈ 0.70 and most homework at d ≈ 0.15 at primary and d ≈ 0.3–0.65 at secondary, with the higher end conditional on feedback quality. The EEF Teaching and Learning Toolkit converges on the same ordering.",
      counselorSentence: "The most powerful single intervention for a student who is slipping is a conversation with their subject teacher about specific feedback — not another tutor. Tutors can help, but only when they are echoing the teacher's feedback, not competing with it.",
      citation: 'Hattie, J. (2023). Visible Learning: The Sequel; EEF Teaching and Learning Toolkit.'
    },
    {
      id: 'anchor-tiger-parenting',
      topic: 'Tiger parenting',
      folkBelief: "Tough, high-pressure parenting is what drives Asian academic success; softening it is Western dilution.",
      evidence: "Kim et al. (2013) tracked 444 Chinese American families for eight years and found that supportive (warm, structured) parenting produced higher GPA, higher educational attainment, closer family bonds, and lower adolescent depression than tiger (controlling, low-warmth) parenting. The study is within-culture — that is what makes it load-bearing.",
      counselorSentence: "The strongest evidence we have from Chinese American families themselves — so not a Western gloss — shows that warmth plus structure out-performs pressure plus control on every outcome. What your child needs from you is not less structure. It is less temperature.",
      citation: 'Kim, S. Y. et al. (2013). Asian American Journal of Psychology, 4(1).'
    },
    {
      id: 'anchor-synergistic-mindset',
      topic: 'Growth mindset in practice',
      folkBelief: 'Teaching students to have a growth mindset will raise their performance.',
      evidence: "Yeager et al. (2019, Nature) found modest effects in a 12,500-student US replication. Yeager et al. (2022, Nature) showed the intervention works much better when combined with teacher practices that treat challenge as normal — the synergistic mindsets finding. Mindset alone is not enough; mindset plus a classroom climate that normalises struggle is where the effect compounds.",
      counselorSentence: "Growth mindset is not a poster. It is a pair of behaviours: the student believes effort moves ability, and the adults around them respond to struggle as information rather than failure. If only the first half is in place, the intervention does very little.",
      citation: 'Yeager, D. S. et al. (2022). Nature, 607; Yeager et al. (2019). Nature, 573.'
    },
    {
      id: 'anchor-grit-nuance',
      topic: 'Grit',
      folkBelief: 'Students who fail need more grit.',
      evidence: "Credé et al. (2017) meta-analysed 88 studies and found grit, as measured, overlaps almost entirely with conscientiousness, with modest independent predictive power once conscientiousness is controlled. The trait is real; the separate brand is oversold.",
      counselorSentence: "Telling a student to have more grit rarely works. What builds the working version of grit is repeated exposure to meaningful challenge with warm adult support and time to reflect on what happened. We can design that. We cannot lecture it into being.",
      citation: 'Credé, M. et al. (2017). Journal of Personality and Social Psychology, 113(3).'
    },
    {
      id: 'anchor-nacac',
      topic: 'Holistic admissions (US)',
      folkBelief: 'US admissions is essentially a test-score and GPA ranking.',
      evidence: "NACAC's State of College Admission reports consistently place grades in college-prep courses and grades overall at the top of the factors admissions officers rate as considerably important, followed by rigor of curriculum, essays, and demonstrated interest. Test scores, since test-optional policies spread in 2020, have slipped from the top tier at a large share of selective US institutions.",
      counselorSentence: "For families focused on US selective admissions, the highest-leverage conversation is not about a test score — it is about the rigor of the curriculum your child has chosen and the strength of the body of work that sits behind it.",
      citation: 'NACAC State of College Admission (most recent edition).'
    },
    {
      id: 'anchor-hepi-ib',
      topic: 'IB vs A-level at UK universities',
      folkBelief: 'A-levels are the gold standard for UK universities; the IB is an alternative.',
      evidence: "HEPI (Higher Education Policy Institute) reports and UCAS data have repeatedly shown that IB Diploma holders matriculate at top-tier UK universities at rates that match or exceed A-level peers, and perform at least as well once there, with particular strength in extended writing and research.",
      counselorSentence: "For Russell Group and Oxbridge applications, the IB Diploma is a competitive credential in its own right, not a consolation prize. The Extended Essay in particular is a signal these universities read carefully.",
      citation: 'HEPI research briefs on IB outcomes; UCAS acceptance data.'
    },
    {
      id: 'anchor-rosenshine',
      topic: 'Explicit instruction',
      folkBelief: 'Inquiry-based teaching is the modern way; explicit instruction is old-fashioned.',
      evidence: "Rosenshine's Principles of Instruction synthesises cognitive science, classroom research, and effective-teacher studies into ten principles (review, small steps, guided practice, checking for understanding, scaffolding, etc.). Kirschner, Sweller, and Clark (2006) make the point formally: pure discovery learning is ineffective for novices. Well-run IB and IGCSE classrooms combine explicit instruction with inquiry — not one at the expense of the other.",
      counselorSentence: "When parents worry that an IB classroom is too student-led, the answer is rarely to defend inquiry in principle. It is to show them how the teacher introduces a concept directly first, then builds the investigation on top. That is what the research actually supports.",
      citation: 'Rosenshine, B. (2012). Principles of Instruction; Kirschner, Sweller, & Clark (2006).'
    },
    {
      id: 'anchor-knowledge-substrate',
      topic: 'Knowledge vs skills',
      folkBelief: 'In the information age, content is Googleable — what matters is skills.',
      evidence: "Willingham (2009), Christodoulou (2014), and the broader cognitive-load tradition all converge on the same finding: working memory is limited, and critical thinking depends on rich long-term knowledge that gives working memory something to work with. Skills are domain-specific; they do not float free of content.",
      counselorSentence: "The IB Learner Profile lists Knowledgeable alongside Thinkers for a reason. When a student cannot analyse, the fix is almost always to strengthen the knowledge base first, then rebuild the analytical skill on top of it.",
      citation: "Willingham, D. (2009). Why Don't Students Like School?; Christodoulou, D. (2014). Seven Myths About Education."
    }
  ],
}
