export const chinaVocabLearningActivity = {
  ...
  researchAnchors: [
    ...
    {
      citation:
        'Wang, G., Zhang, Y., Zhao, J., et al. (2022). Implementation and Challenges of Online Education during the COVID-19 Outbreak: A National Survey of Children and Parents in China.',
      doi: '10.1371/journal.pone.0270646',
      url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC9334978/',
      use: 'D2 — National survey documenting parent-teacher WeChat communication during COVID-19 remote learning. Shows parents\' expanded supervisory role, co-education partnerships, and widespread anxiety about online teaching quality. Establishes that the WeChat accountability dynamic intensified significantly post-2020.',
    },
    {
      citation:
        'Zhang, T. H. (2021). Chinese parents\' perception of emergency remote K-12 teaching-learning in China during the COVID-19 pandemic.',
      doi: 'n/a',
      url: 'https://files.eric.ed.gov/fulltext/EJ1303710.pdf',
      use: 'D2 — Chinese parents\' perceptions of emergency remote schooling: anxiety, evolving expectations, and shifts in home-school partnerships. Pairs with the PLOS ONE survey for a qualitative-quantitative D2 update.',
    },
    {
      citation:
        'Chen, L., & Lin, S. (2024). Examining China\'s \'Double Reduction\' Policy: Promises and Challenges for Balanced and Quality Development in Compulsory Education.',
      doi: '10.1177/20965311241265123',
      url: 'https://journals.sagepub.com/doi/full/10.1177/20965311241265123',
      use: 'D3 — Peer-reviewed analysis of 双减 policy: intent to reduce exam-oriented memorisation, implementation challenges, parent responses including underground tutoring markets. Best single academic source for institutional context.',
    },
    {
      citation:
        'Academic Integrity in China: Challenges for Policy, Practice, and Quality Assurance in Higher Education. (2024). Springer Nature.',
      doi: '10.1007/978-3-031-54144-5_175',
      url: 'https://link.springer.com/10.1007/978-3-031-54144-5_175',
      use: 'D4 — Guanxi-based authorship practices, relationship-building norms vs. Western integrity frameworks, and the gap between government integrity policies (since 2009) and entrenched cultural practice. Directly relevant to understanding academic integrity through a relational lens.',
    },
    {
      citation:
        'Analysis of classroom silence behaviours among Chinese and Korean undergraduates. (2024). PMC.',
      doi: 'n/a',
      url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC12713118/',
      use: 'D5 — Quantitative analysis of classroom silence and reluctance to ask questions. Speaking anxiety and contextual rigidity are the strongest predictors. COVID post-lockdown impact on self-efficacy and classroom participation is documented. Cross-applies to Korea D5.',
    },
    {
      citation:
        'Post-pandemic shifts in online learning: motivation and engagement of Chinese students. (2025). Educational Studies, Taylor & Francis.',
      doi: '10.1080/13803611.2025.2482618',
      url: 'https://www.tandfonline.com/doi/full/10.1080/13803611.2025.2482618',
      use: 'D5 — Longitudinal study showing post-pandemic changes in intrinsic/extrinsic motivation and engagement. Intrinsic motivation declined; performance anxiety increased. Strong update for post-COVID classroom dynamic.',
    },
    {
      citation:
        'Influence of the first wave of COVID-19 on Chinese students\' psychology and behaviour. (2024). PMC.',
      doi: 'n/a',
      url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC11217512/',
      use: 'D5 — COVID psychological and behavioural impact: perfectionism, depression, anxiety, and changes in classroom engagement. Use to update classroom behaviour sections.',
    },
    {
      citation:
        'Psychological detachment in Chinese higher education: a multitheoretical model of academic stress, cultural pressure, and coping resources. (2025). Frontiers in Psychology.',
      doi: '10.3389/fpsyg.2025.1647184',
      url: 'https://www.frontiersin.org/journals/psychology/articles/10.3389/fpsyg.2025.1647184/full',
      use: 'D5 — Perfectionist tendencies, rumination, fear of underperformance, and cumulative academic stressors specific to Chinese students. Theoretical grounding for classroom behaviour interpretation.',
    },
  ],
  facilitatorNote:
      ...
      cards: [
        {
          ...
          deeperMeaning:
            'In many China-based school communities, WeChat is not just logistics. It can become the place where standards, speed, and teacher responsiveness are publicly judged. COVID-19 accelerated this: national survey data (Wang et al., 2022, PLOS ONE) shows that during remote schooling, WeChat parent groups became the primary channel for co-education — parents were explicitly recruited as supervisory partners and their expectations of teacher responsiveness increased significantly. The dynamic that emerged during 2020–2022 has not fully receded: many families entered the post-pandemic school environment with a WeChat communication style shaped by two years of crisis co-management.',
          whyItMatters:
            'A teacher may hear a group question as disrespect. A parent may hear the same move as efficient shared clarification. Post-COVID, this gap has widened: research on Chinese parents during emergency remote teaching (Zhang, 2021) found that parents\' sense of co-responsibility for learning outcomes increased markedly — and so did their inclination to surface concerns collectively rather than privately. The WeChat group has become a higher-stakes environment than pre-2020 assumptions suggest.',
          commonMisread:
