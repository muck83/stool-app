...
export const MODULE_META = {
  'ksa-ib':               { slug: 'ksa-ib',               dbId: 'ksa-001',       flag: 'SA', label: 'Understand Saudi Arabia',          lang: 'EN / AR',  desc: 'Tawjihiyya, family expectations, and navigating IB in a Gulf context.', preamble_md: 'This module explores the cultural dynamics that shape how families from Saudi Arabia engage with international schools.' },
  ...
  'korea-ib':             { slug: 'korea-ib',             dbId: 'korea-001',     flag: 'KR', label: 'Understand Korea',                 lang: 'EN / KO',  desc: 'Suneung pressure and the Korean parents relationship with teacher authority.', preamble_md: 'This module explores the cultural dynamics that shape how families from Korea engage with international schools.' },
  'china-ib':             { slug: 'china-ib',             dbId: 'china-001',     flag: 'CN', label: 'Understand China',                 lang: 'EN / ZH',  desc: 'Gaokao culture and what "no ranking" means to a Chinese parent.', preamble_md: 'This module explores the cultural dynamics that shape how families from China engage with international schools.' },
  'vietnam-ib':           { slug: 'vietnam-ib',           dbId: 'vietnam-001',   flag: 'VN', label: 'Understand Vietnam',               lang: 'EN / VI',  desc: 'Filial piety, academic honour, and teaching in a system mid-reform.', preamble_md: 'Vietnamese families invest in international schools as a different route to the outcomes the national system promises.' },
  'japan-ib':             { slug: 'japan-ib',             dbId: 'japan-001',     flag: 'JP', label: 'Understand Japan',                 lang: 'EN / JA',  desc: 'Entrance exams, collective harmony, and the invisible pressure on your students.', preamble_md: 'Japanese families choosing international schools are not abandoning the system that shaped them.' },
  ...
  'indonesia-ib':         { slug: 'indonesia-ib',         dbId: 'indonesia-001', flag: 'ID', label: 'Understand Indonesia',             lang: 'EN / ID',  desc: 'UTBK pressure, face dynamics, and the faith dimension.', preamble_md: 'Indonesian families who choose international schools are navigating a dual identity.' },
  'uae-ib':               { slug: 'uae-ib',               dbId: 'uae-001',       flag: 'AE', label: 'Understand UAE',                   lang: 'EN / AR',  desc: 'Wasta, school choice as social capital, and the Emirati family inside a global curriculum.', preamble_md: 'Families in the UAE who choose international schools are not a monolith.' },
}
