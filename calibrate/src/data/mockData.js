...
export const MODULE_META = {
  ...
  'japan-ib':            { slug: 'japan-ib',            dbId: 'japan-001',     flag: '🇯🇵', label: 'Understand Japan',                 lang: 'EN / JA',    desc: 'Entrance exams, collective harmony, and the invisible pressure on your students.', preamble_md: 'Japanese families choosing international schools are not abandoning the system that shaped them — they are hedging against it. This module asks you to understand why narrative assessment feels like silence to a family that built their life on ranked scores.' },
