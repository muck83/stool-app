-- ══════════════════════════════════════════════════════════════════════════════
-- Vietnam Module — Calibrate PD Layer
-- Audience: foreign / international teachers at international schools
-- DB ID: vietnam-001
-- Run AFTER cal_seed_part1.sql (tables must exist) and 20260330_create_simulations.sql
-- ══════════════════════════════════════════════════════════════════════════════
...
INSERT INTO pd_modules (id, country_code, title, tagline, status)
VALUES (
  'vietnam-001',
  'VN',
  'Understanding Vietnam',
  'Filial piety, academic honour, and teaching in a system mid-reform',
  'live'
)
...
-- ── VERIFICATION ─────────────────────────────────────────────────────────────
SELECT count(*) FROM pd_dimensions WHERE module_id = 'vietnam-001';     -- expect 6
SELECT count(*) FROM pd_quiz_questions WHERE module_id = 'vietnam-001'; -- expect 9
SELECT count(*) FROM pd_simulations WHERE module_id = 'vietnam-001';    -- expect 3
