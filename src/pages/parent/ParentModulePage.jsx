...
function ConceptCard({ card, lang, index, activeStage, whatToAskNote }) {
  ...
  const c = card[lang]
  const colors = ['#0E8A5F', '#185FA5', '#A35E08', '#3F3A8F', '#C0392B']
        ...
        {phase === 'reveal' && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', marginTop: '.5rem' }}>
            <div style={{
              ...
              background: '#DCF0E6', border: '1px solid #0E8A5F44',
            }}>
        ...
        <div style={{ marginTop: '1.25rem' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)', gap: 4 }}>
            {data.en.boundaries.map(b => {
              ...
              const c = b.grade >= 6 ? '#0E8A5F' : b.grade >= 4 ? '#185FA5' : b.grade >= 2 ? '#A35E08' : '#C0392B'
              return (
...
function DpCalculator({ data, lang }) {
  ...
  const totalColor = passes ? '#0E8A5F' : '#C0392B'
    ...
    <div style={{ border: '1px solid var(--border)', borderRadius: 'var(--r)', overflow: 'hidden', marginBottom: '1.5rem' }}>
      ...
      <div style={{ padding: '1.1rem 1.2rem' }}>
        ...
        <div style={{
          ...
          background: corePoints > 0 ? '#DCF0E6' : corePoints === -1 ? '#FEF3F2' : 'var(--surface-2)',
          borderRadius: 'var(--r)', border: `1px solid ${corePoints > 0 ? '#0E8A5F44' : corePoints === -1 ? '#C0392B44' : 'var(--border)'}`,
          ...
          <div style={{ fontSize: 18, fontWeight: 800, color: corePoints > 0 ? '#0E8A5F' : corePoints === -1 ? '#C0392B' : 'var(--ink-4)' }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            background: passes ? '#0E8A5F' : '#C0392B', color: 'white',
          }}>
            {passes
...
function APScoreTable({ data, lang }) {
  ...
  const scoreColors = { 5: '#0E8A5F', 4: '#185FA5', 3: '#A35E08', 2: '#C0392B', 1: '#7F8C8D' }
      ...
      {b.changes && b.changes.length > 0 && (
        <div style={{ marginBottom: '1.5rem', border: '1px solid var(--border)', borderRadius: 'var(--r)', overflow: 'hidden' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', background: 'var(--surface-2)', borderBottom: '1px solid var(--border)', padding: '.75rem 1rem', gap: '1rem' }}>
            ...
            <div style={{ fontSize: 11, fontWeight: 700, color: '#A35E08', textTransform: 'uppercase', letterSpacing: '.07em' }}>PYP</div>
    ...
    <div style={{ marginBottom: '2rem' }}>
          ...
          return (
            <button
              ...
              style={{
                ...
                background: isSelected ? 'var(--teal-faint, #DCF0E6)' : 'var(--surface-2)',
                transition: 'border .15s, background .15s',
                display: 'flex', alignItems: 'center', gap: '.75rem',
              }}
            >
      ...
      {path && (
        <div style={{ border: '1px solid var(--teal)44', borderRadius: 'var(--r)', overflow: 'hidden' }}>
          <div style={{ padding: '.875rem 1.2rem', background: 'var(--teal-faint, #DCF0E6)', borderBottom: '1px solid var(--teal)33', display: 'flex', alignItems: 'center', gap: '.5rem' }}>
        ...
        <div>
          ...
          {m.reassurance && (
            <div style={{
              ...
              background: '#DCF0E6', borderRadius: 'var(--r)',
              border: '1px solid #0E8A5F33',
            }}>
              <div style={{ fontSize: 11, fontWeight: 600, color: '#0E8A5F', textTransform: 'uppercase', letterSpacing: '.07em', marginBottom: 5 }}>
        ...
        <div>
          ...
          {!done ? (
            ...
            <div style={{
              ...
              <div style={{ fontSize: 14, fontWeight: 600, color: '#0E8A5F' }}>
