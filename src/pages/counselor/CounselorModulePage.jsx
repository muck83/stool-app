...
const SECTIONS = [
  ...
  { id: 'research',  label: 'Research Anchors'   },
...
export default function CounselorModulePage() {
  ...
  return (
    <div style={{ maxWidth: 680, margin: '0 auto', padding: '1.5rem 1.25rem 4rem' }}>
      ...
      {/* ── RESEARCH ANCHORS ──────────────────────────────────────────────── */}
      {activeSection === 'research' && activity.researchAnchors && (
        <div>
          <div style={{ marginBottom: '1.25rem' }}>
            <div style={{ fontSize: 11, fontWeight: 700, color: 'var(--teal)', textTransform: 'uppercase', letterSpacing: '.07em', marginBottom: 6 }}>
              Research anchors
            </div>
            <h2 style={{ fontFamily: 'var(--serif, Georgia, serif)', fontSize: '1.3rem', color: 'var(--ink)', margin: '0 0 8px' }}>
              Citable evidence for parent meetings
            </h2>
            <p style={{ fontSize: 13.5, color: 'var(--ink-3)', lineHeight: 1.65, margin: 0 }}>
              Eight research findings you can bring into a parent conversation to reframe a common folk belief. Each includes the folk belief, what the evidence actually shows, and a specific sentence you can say in the room.
            </p>
          </div>
          {activity.researchAnchors.map((a, i) => (
            <div key={a.id} style={{
              border: '1px solid var(--border)',
              borderRadius: 14,
              ...
              <div style={{ fontSize: 11, fontWeight: 600, color: 'var(--teal)', textTransform: 'uppercase', letterSpacing: '.06em', marginBottom: 6 }}>
                Anchor {i + 1} · {a.topic}
              </div>
              <div style={{ fontSize: 13, color: 'var(--ink-3)', marginBottom: 10, fontStyle: 'italic' }}>
                <strong style={{ color: 'var(--ink)', fontStyle: 'normal' }}>Folk belief:</strong> {a.folkBelief}
              </div>
              <div style={{ fontSize: 13, color: 'var(--ink-2)', lineHeight: 1.65, marginBottom: 10 }}>
                <strong style={{ color: 'var(--ink)' }}>What the evidence shows:</strong> {a.evidence}
              </div>
              <div style={{
                ...
                <strong style={{ fontStyle: 'normal' }}>Say this in the room:</strong> {a.counselorSentence}
              </div>
              {a.citation && (
                <div style={{ fontSize: 11.5, color: 'var(--ink-3)', lineHeight: 1.5 }}>
                  <strong>Source:</strong> {a.citation}
                </div>
              )}
            </div>
          ))}
