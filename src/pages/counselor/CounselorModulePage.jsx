          ...
          return (
            <button
              ...
              style={{
                ...
                background: isActive ? 'var(--teal)' : isRec ? 'var(--teal-faint, #E1F5EE)' : 'var(--surface-2)',
...
function CounselorCard({ card, index, activeStage, onShareBridge }) {
  ...
  const colors = ['#1D9E75', '#185FA5', '#BA7517', '#534AB7', '#C0392B', '#0E7490']
        ...
        <div style={{ padding: '1rem 1.2rem 1.25rem', borderTop: `1px solid ${col}22` }}>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '1rem', marginBottom: 6, flexWrap: 'wrap' }}>
              <div style={{ fontSize: 11, fontWeight: 600, color: '#1D9E75', textTransform: 'uppercase', letterSpacing: '.05em' }}>
              ...
              <button
                ...
                style={{
                  ...
                  background: copied ? '#1D9E75' : 'white',
                  color: copied ? 'white' : '#1D9E75',
            ...
            {card.parentBridge.moduleLink && (
              <div style={{ marginTop: 8 }}>
                <Link
                  ...
                  style={{ fontSize: 12, color: '#1D9E75', textDecoration: 'underline', fontWeight: 600 }}
                >
...
function BranchingScenario({ scenario, index }) {
  ...
  const OUTCOME_COLORS = { best: '#1D9E75', partial: '#BA7517', difficult: '#C0392B' }
            ...
            {scenario.branches.map(branch => (
              <button
                ...
                onMouseEnter={e => {
                  ...
                  e.currentTarget.style.background = 'var(--teal-faint, #E1F5EE)'
                }}
                onMouseLeave={e => {
...
function EeTokMatrix({ data }) {
  ...
  const ptColor = points === null ? 'var(--ink-4)' : points === 3 ? '#1D9E75' : points >= 1 ? '#185FA5' : points === 0 ? '#BA7517' : '#C0392B'
