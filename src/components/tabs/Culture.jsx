...
export default function Culture() {
  ...
  if (profile.dc && HOF[profile.dc]) {
    countries.push({ key: 'dest', label: 'Next', country: profile.dc, scores: HOF[profile.dc], color: '#534AB7' })
  }
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: '.4rem' }}>
                ...
                <span style={{
                  ...
                  color: gapColor(currentShift.gap),
                  background: currentShift.gap > 30 ? '#FAECE7' : currentShift.gap > 15 ? '#FAEEDA' : '#E1F5EE',
                  padding: '2px 8px',
                  borderRadius: 999,
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: '.4rem' }}>
                ...
                <span style={{
                  fontSize: 11, fontWeight: 600,
                  color: gapColor(nextShift.gap),
                  background: nextShift.gap > 30 ? '#FAECE7' : nextShift.gap > 15 ? '#FAEEDA' : '#E1F5EE',
                  padding: '2px 8px',
                  borderRadius: 999,
