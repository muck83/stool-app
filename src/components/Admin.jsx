  ...
  return (
    <div>
      <StatGrid columns={3} items={[
        ...
        ['From diagnostic', rows.filter(r => r.source === 'diagnostic').length, '#534AB7'],
      ]} />
            ...
            <tbody>
              {filtered.length === 0 ? (
                ...
                <tr key={r.email} style={{ borderBottom: '1px solid var(--border)', background: i % 2 === 0 ? 'white' : '#FAFAF9' }}>
                  ...
                  <td style={{ padding: '7px 12px' }}>
                    <span style={{ fontSize: 10, fontWeight: 600, padding: '2px 7px', borderRadius: 10, background: r.source === 'profile' ? '#E6F1FB' : '#EEEDFE', color: r.source === 'profile' ? '#185FA5' : '#534AB7', textTransform: 'capitalize' }}>
                      {r.source}
                    </span>
                  </td>
